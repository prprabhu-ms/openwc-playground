...
export type CustomEvent<DetailType> = Event & { detail: DetailType };
...
export const wrapElementWithTypedReact = <Props, TElement extends HTMLElement, CustomEventMap>(element: Constructable<TElement>, eventMappings: HandlerEventNameMappings<CustomEventMap>): (props: Props | Handlers<CustomEventMap> | {children?: React.ReactNode}) => JSX.Element => {
